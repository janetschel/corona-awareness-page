  ...
  return(
      <div className="Content" id="Content">
        ...
        <Typography>
          ...
          - zu schützen, und deshalb auch in unserem Grundgesetz im fünften Artikel verankert.
        </Typography>
        ...
        <Typography>
          So hoch und grauensam diese Zahl auch scheinen mögen, können wir uns glücklich schätzen, dass COVID-19 in Deutschland nur so
        ...
        <Typography>
          ...
          welche <strong>bewusst</strong> Falschinformationen ohne jegliche Reue zu verpühren, blindlings an ihre Anhänger
          propagieren.
        </Typography>
        <Typography>
          <strong>DAS</strong> ist das eigentliche Problem, welchen wir in Mitten der Corona-Pandemie noch zusätzlich gegenüber stehen.
        ...
        <Typography>
          ...
          <strong> aller Mitbürger</strong> vor unsere persönliche Entfaltung.
        </Typography>
        <Typography>
